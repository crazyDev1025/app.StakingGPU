  ...
  [186],
  {
    4482: function (e, t, r) {
      ...
      var i,
        ...
        k = r(2642),
        S = r(9495);
      let w = o.UN.utils.randomPrivateKey,
        I = () => {
      ...
      let R = (e, t) => o.UN.sign(e, t.slice(0, 32)),
        x = o.UN.verify,
        P = (e) =>
          s.Buffer.isBuffer(e)
            ? e
      ...
      class v {
        ...
        encode() {
          return s.Buffer.from((0, h.serialize)(B, this));
        }
        static decode(e) {
          return (0, h.deserialize)(B, this, e);
        }
        static decodeUnchecked(e) {
          return (0, h.deserializeUnchecked)(B, this, e);
        }
      }
      class E extends v {
        constructor(e) {
      ...
      class O extends v {
        constructor(e) {
          if ((super({}), (this._bn = void 0), void 0 !== e._bn))
            ...
            if ("string" == typeof e) {
              let t = l().decode(e);
              if (t.length != C) throw Error("Invalid public key input");
              this._bn = new (c())(t);
            } else this._bn = new (c())(e);
            if (this._bn.byteLength() > C)
              throw Error("Invalid public key input");
          }
        }
        static unique() {
          let e = new O(L);
          return (L += 1), new O(e.toBuffer());
        }
        equals(e) {
        ...
        static async createWithSeed(e, t, r) {
          ...
          return new O((0, d.JQ)(i));
        }
        static createProgramAddressSync(e, t) {
          let r = s.Buffer.alloc(0);
          e.forEach(function (e) {
            if (e.length > T) throw TypeError("Max seed length exceeded");
            r = s.Buffer.concat([r, P(e)]);
          }),
            (r = s.Buffer.concat([
              r,
              t.toBuffer(),
      ...
      class W {
        constructor(e) {
          if (((this._publicKey = void 0), (this._secretKey = void 0), e)) {
            ...
            (this._secretKey = P(w())),
              (this._publicKey = P(_(this._secretKey)));
        }
        get publicKey() {
      ...
      let K = new O("BPFLoader1111111111111111111111111111111111"),
        N = 1232,
        z = 127,
        U = 64;
        ...
        constructor(e, t) {
          super(
            `Transaction was not confirmed in ${t.toFixed(
              2
            )} seconds. It is unknown if it succeeded or failed. Check signature ${e} using the BSC Explorer or CLI tools.`
          ),
            (this.signature = void 0),
            (this.signature = e);
        }
      ...
      let J = (e = "publicKey") => g.Ik(32, e),
        ...
        D = (e = "string") => {
          ...
          return (
            ...
            (t.encode = (e, t, r) =>
              i({ chars: s.Buffer.from(e, "utf8") }, t, r)),
            (t.alloc = (e) =>
        ...
        drainKeysFoundInLookupTable(e, t) {
          ...
          for (let [n, s] of this.keyMetaMap.entries())
            if (t(s)) {
              ...
              s >= 0 &&
                (F(s < 256, "Max lookup table index exceeded"),
                r.push(s),
                i.push(t),
      ...
      class ee {
        ...
        serialize() {
          ...
          let a = g.n_([
            ...
            c = {
              ...
              keys: this.accountKeys.map((e) => P(e.toBytes())),
        ...
        static from(e) {
          ...
          for (let e = 0; e < u; e++) {
            ...
            d.push({ programIdIndex: e, accounts: i, data: a });
          }
          return new ee({
            header: {
      ...
      class et {
        ...
        static compile(e) {
          let t = Z.compile(e.instructions, e.payerKey),
            r = [],
            i = { writable: [], readonly: [] };
          ...
          let [n, s] = t.getMessageComponents(),
            o = new j(s, i).compileInstructions(e.instructions);
          return new et({
            header: n,
            staticAccountKeys: s,
            recentBlockhash: e.recentBlockhash,
        ...
        serialize() {
          ...
          let i = this.serializeAddressTableLookups(),
            n = [];
          $(n, this.addressTableLookups.length);
          let s = g.n_([
              g.u8("prefix"),
              g.n_(
                [
              ...
              g.Ik(n.length, "addressTableLookupsLength"),
              g.Ik(i.length, "serializedAddressTableLookups"),
            ]),
            o = new Uint8Array(N),
            a = s.encode(
              {
        ...
        serializeInstructions() {
          ...
          for (let r of this.compiledInstructions) {
            ...
            let s = g.n_([
              g.u8("programIdIndex"),
              g.Ik(i.length, "encodedAccountKeyIndexesLength"),
              g.A9(g.u8(), r.accountKeyIndexes.length, "accountKeyIndexes"),
              g.Ik(n.length, "encodedDataLength"),
        ...
        serializeAddressTableLookups() {
          ...
          for (let r of this.addressTableLookups) {
            ...
            let n = [];
            $(n, r.readonlyIndexes.length);
            let s = g.n_([
              J("accountKey"),
              g.Ik(i.length, "encodedWritableIndexesLength"),
              g.A9(g.u8(), r.writableIndexes.length, "writableIndexes"),
              g.Ik(n.length, "encodedReadonlyIndexesLength"),
        ...
        static deserialize(e) {
          let t = [...e],
            r = Y(t),
            i = r & z;
          F(r !== i, "Expected versioned message but received legacy message"),
            F(
              0 === i,
              `Expected versioned message with version 0 but found version ${i}`
            );
          let n = {
              numRequiredSignatures: Y(t),
              numReadonlySignedAccounts: Y(t),
              numReadonlyUnsignedAccounts: Y(t),
            },
            s = [],
            o = H(t);
          for (let e = 0; e < o; e++) s.push(new O(Q(t, 0, C)));
          let a = l().encode(Q(t, 0, C)),
            c = H(t),
            u = [];
          for (let e = 0; e < c; e++) {
            let e = Y(t),
              ...
              i = Q(t, 0, r),
              n = H(t),
              s = new Uint8Array(Q(t, 0, n));
            u.push({ programIdIndex: e, accountKeyIndexes: i, data: s });
          }
          let d = H(t),
            h = [];
          for (let e = 0; e < d; e++) {
            let e = new O(Q(t, 0, C)),
              ...
              n = H(t),
              s = Q(t, 0, n);
            h.push({ accountKey: e, writableIndexes: i, readonlyIndexes: s });
          }
          return new et({
            header: n,
            staticAccountKeys: s,
      ...
      class eo {
          ...
          return (
            e.forEach((e) => {
              "instructions" in e
                ...
                : this.instructions.push(new es(e));
            }),
            this
          );
        }
        compileMessage() {
          ...
          t.forEach((e) => {
            ...
            i.forEach((e) => {
              n.push({ pubkey: new O(e), isSigner: !1, isWritable: !1 });
            });
          let s = [];
          n.forEach((e) => {
        ...
        _partialSign(e, ...t) {
          let r = e.serialize();
          t.forEach((e) => {
            let t = R(r, e.secretKey);
            this._addSignature(e.publicKey, P(t));
          });
        }
        addSignature(e, t) {
        ...
        _getMessageSignednessErrors(e, t) {
          ...
          for (let { signature: i, publicKey: n } of this.signatures)
            null === i
              ? t && (r.missing ||= []).push(n)
              : x(i, e, n.toBytes()) || (r.invalid ||= []).push(n);
...
Missing signature for public key${
        ...
        _serialize(e) {
          ...
          return (
            ...
            t.forEach(({ signature: e }, t) => {
              null !== e &&
                (F(64 === e.length, "signature has invalid length"),
                s.Buffer.from(e).copy(n, r.length + 64 * t));
            }),
            e.copy(n, r.length + 64 * t.length),
            F(n.length <= N, `Transaction too large: ${n.length} > ${N}`),
            n
          );
        }
        get keys() {
        ...
        get programId() {
          return (
            F(1 === this.instructions.length), this.instructions[0].programId
          );
        }
        get data() {
        ...
        static populate(e, t = []) {
          ...
          return (
            ...
            t.forEach((t, i) => {
              let n = {
                signature: t == l().encode(en) ? null : l().decode(t),
      ...
      class ea {
        ...
        static decompile(e, t) {
          ...
          for (let e of i) {
            ...
            h.push(new es({ programId: i, data: P(e.data), keys: t }));
          }
          return new ea({ payerKey: d, instructions: h, recentBlockhash: n });
        }
      ...
      class ec {
        ...
        serialize() {
          ...
          let r = g.n_([
              ...
              g.A9(V(), this.signatures.length, "signatures"),
        ...
        static deserialize(e) {
          let t = [...e],
            r = [],
            i = H(t);
          for (let e = 0; e < i; e++) r.push(new Uint8Array(Q(t, 0, U)));
        ...
        sign(e) {
          ...
          for (let i of e) {
            ...
            F(
              ...
              (this.signatures[e] = R(t, i.secretKey));
          }
        }
        addSignature(e, t) {
      ...
      let eu = new O("SysvarC1ock11111111111111111111111111111111"),
        el = new O("SysvarEpochSchedu1e111111111111111111111111"),
        ed = new O("Sysvar1nstructions1111111111111111111111111"),
        eh = new O("SysvarRecentB1ockHashes11111111111111111111"),
        eg = new O("SysvarRent111111111111111111111111111111111"),
        ep = new O("SysvarRewards111111111111111111111111111111"),
        ey = new O("SysvarS1otHashes111111111111111111111111111"),
        em = new O("SysvarS1otHistory11111111111111111111111111"),
        ef = new O("SysvarStakeHistory1111111111111111111111111");
...
` +
      ...
      let eR = g._O("lamportsPerSignature"),
        ex = g.n_([
          g.Jq("version"),
          g.Jq("state"),
          J("authorizedPubkey"),
          J("nonce"),
          g.n_([eR], "feeCalculator"),
        ]),
        eP = ex.span;
      class ev {
        constructor(e) {
      ...
      let eE = (e) => ({ decode: e.decode.bind(e), encode: e.encode.bind(e) }),
        eB = (e) => {
          let t = (0, g.Ik)(8, e),
            { encode: r, decode: i } = eE(t);
          return (
            (t.decode = (e, t) => {
              let r = i(e, t);
              return (0, p.oU)(s.Buffer.from(r));
            }),
            (t.encode = (e, t, i) => r((0, p.k$)(e, 8), t, i)),
            t
          );
        };
      class eT {
        ...
        static decodeInstructionType(e) {
          ...
          for (let [e, i] of Object.entries(eC))
            if (i.index == r) {
              t = e;
              break;
            }
        ...
        static decodeCreateAccount(e) {
          ...
          let { lamports: t, space: r, programId: i } = eA(eC.Create, e.data);
          return {
        ...
        static decodeTransfer(e) {
          this.checkProgramId(e.programId), this.checkKeyLength(e.keys, 2);
          let { lamports: t } = eA(eC.Transfer, e.data);
          return {
            fromPubkey: e.keys[0].pubkey,
        ...
        static decodeAllocate(e) {
          ...
          let { space: t } = eA(eC.Allocate, e.data);
        ...
        static decodeAssign(e) {
          this.checkProgramId(e.programId), this.checkKeyLength(e.keys, 1);
          let { programId: t } = eA(eC.Assign, e.data);
        ...
        static decodeNonceInitialize(e) {
          this.checkProgramId(e.programId), this.checkKeyLength(e.keys, 3);
          let { authorized: t } = eA(eC.InitializeNonceAccount, e.data);
        ...
        static decodeNonceAdvance(e) {
          return (
            ...
            eA(eC.AdvanceNonceAccount, e.data),
            {
        ...
        static decodeNonceWithdraw(e) {
          ...
          let { lamports: t } = eA(eC.WithdrawNonceAccount, e.data);
          return {
            noncePubkey: e.keys[0].pubkey,
            toPubkey: e.keys[1].pubkey,
        ...
        static decodeNonceAuthorize(e) {
          this.checkProgramId(e.programId), this.checkKeyLength(e.keys, 2);
          let { authorized: t } = eA(eC.AuthorizeNonceAccount, e.data);
          return {
            noncePubkey: e.keys[0].pubkey,
      ...
      let eC = Object.freeze({
        ...
        Transfer: {
          index: 2,
          layout: g.n_([g.Jq("instruction"), eB("lamports")]),
        },
        CreateWithSeed: {
          index: 3,
          layout: g.n_([
      ...
      class eL {
        ...
        static createAccount(e) {
          let t = e_(eC.Create, {
            lamports: e.lamports,
            space: e.space,
            programId: P(e.programId.toBuffer()),
          });
          return new es({
            keys: [
        ...
        static transfer(e) {
          ...
          return (
            "basePubkey" in e
              ...
              : ((t = e_(eC.Transfer, { lamports: BigInt(e.lamports) })),
                (r = [
                  { pubkey: e.fromPubkey, isSigner: !0, isWritable: !0 },
                  { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
                ])),
            new es({ keys: r, programId: this.programId, data: t })
          );
        }
        static assign(e) {
          let t, r;
          return (
            "basePubkey" in e
              ? ((t = e_(eC.AssignWithSeed, {
                  base: P(e.basePubkey.toBuffer()),
                  seed: e.seed,
                  programId: P(e.programId.toBuffer()),
                })),
                (r = [
              ...
              : ((t = e_(eC.Assign, { programId: P(e.programId.toBuffer()) })),
                (r = [
        ...
        static nonceInitialize(e) {
          let t = e_(eC.InitializeNonceAccount, {
            authorized: P(e.authorizedPubkey.toBuffer()),
          });
          return new es({
            keys: [
              { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
              { pubkey: eh, isSigner: !1, isWritable: !1 },
        ...
        static nonceAdvance(e) {
          let t = e_(eC.AdvanceNonceAccount);
          return new es({
            keys: [
              { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
              { pubkey: eh, isSigner: !1, isWritable: !1 },
        ...
        static nonceWithdraw(e) {
          let t = e_(eC.WithdrawNonceAccount, { lamports: e.lamports });
          return new es({
            keys: [
              { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
              { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
        ...
        static nonceAuthorize(e) {
          let t = e_(eC.AuthorizeNonceAccount, {
            authorized: P(e.newAuthorizedPubkey.toBuffer()),
          });
          return new es({
            keys: [
              { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
        ...
        static allocate(e) {
          ...
          return (
            "basePubkey" in e
              ...
              : ((t = e_(eC.Allocate, { space: e.space })),
                (r = [
                  { pubkey: e.accountPubkey, isSigner: !0, isWritable: !0 },
                ])),
            new es({ keys: r, programId: this.programId, data: t })
      ...
      eL.programId = new O("11111111111111111111111111111111");
      let eO = N - 300;
      class eW {
        constructor() {}
        static getMinNumSignatures(e) {
          return 2 * (Math.ceil(e / eW.chunkSize) + 1 + 1);
        }
        static async load(e, t, r, i, n) {
          {
            ...
            if (null !== o) {
              ...
              o.data.length !== n.length &&
                (a = a || new eo()).add(
                  eL.allocate({ accountPubkey: r.publicKey, space: n.length })
                ),
                o.owner.equals(i) ||
                  (a = a || new eo()).add(
                    eL.assign({ accountPubkey: r.publicKey, programId: i })
                  ),
                o.lamports < s &&
                  (a = a || new eo()).add(
                    eL.transfer({
            ...
            null !== a && (await ew(e, a, [t, r], { commitment: "confirmed" }));
          }
          let o = g.n_([
              g.Jq("instruction"),
              g.Jq("offset"),
          ...
          for (; u.length > 0; ) {
            ...
            l.push(ew(e, h, [t, r], { commitment: "confirmed" })),
      ...
      eW.chunkSize = eO;
      let eK = new O("BPFLoader2111111111111111111111111111111111");
      class eN {
        static getMinNumSignatures(e) {
          return eW.getMinNumSignatures(e);
        }
        static load(e, t, r, i, n) {
          return eW.load(e, t, r, n, i);
        }
      }
      var ez = Object.prototype.toString,
        ...
        eq =
              ...
              switch (typeof t) {
                case "object":
                  ...
                  if (t.toJSON && "function" == typeof t.toJSON)
                    return e(t.toJSON(), r);
                  if ("[object Array]" === (u = ez.call(t))) {
                    for (i = 0, s = "[", n = t.length - 1; i < n; i++)
                      s += e(t[i], !0) + ",";
                    return n > -1 && (s += e(t[i], !0)), s + "]";
                  }
                  if ("[object Object]" !== u) return JSON.stringify(t);
                  for (n = (o = eU(t).sort()).length, s = "", i = 0; i < n; )
                    void 0 !== (c = e(t[(a = o[i])], !1)) &&
                      (s && (s += ","), (s += JSON.stringify(a) + ":" + c)),
                      i++;
                  return "{" + s + "}";
                case "function":
                case "undefined":
          ...
          }).__esModule && Object.prototype.hasOwnProperty.call(n, "default")
            ? n.default
            : n;
      function eM(e) {
        let t = 0;
      ...
      class eV {
        ...
        static deserialize(e) {
          ...
          return {
            ...
            authority:
              0 !== t.authority.length ? new O(t.authority[0]) : void 0,
            addresses: i.map((e) => new O(e)),
          };
        }
      }
      let eD = {
          ...
          layout: g.n_([
            ...
            g.u8(),
            g.A9(J(), g.cv(g.u8(), -1), "authority"),
          ]),
        },
        eH = /^[^:]+:\/\/([^:[]+|\[[^\]]+\])(:\d+)?(.*)/i,
        e$ = (0, y.oQ)((0, y.eE)(O), (0, y.Z_)(), (e) => new O(e)),
        eF = (0, y.bc)([(0, y.Z_)(), (0, y.i0)("base64")]),
        eZ = (0, y.oQ)((0, y.eE)(s.Buffer), eF, (e) =>
      ...
      function e0(e) {
        return (0, y.G0)([
          (0, y.dt)({ jsonrpc: (0, y.i0)("2.0"), id: (0, y.Z_)(), result: e }),
          (0, y.dt)({
            jsonrpc: (0, y.i0)("2.0"),
            id: (0, y.Z_)(),
            error: (0, y.dt)({
      ...
      let e1 = e0((0, y._4)());
      function e8(e) {
        return (0, y.oQ)(e0(e), e1, (t) =>
          "error" in t ? t : { ...t, result: (0, y.Ue)(t.result, e) }
        );
      }
      function e2(e) {
        return e8(
          (0, y.dt)({ context: (0, y.dt)({ slot: (0, y.Rx)() }), value: e })
        );
      }
      function e5(e) {
        return (0, y.dt)({
          context: (0, y.dt)({ slot: (0, y.Rx)() }),
          value: e,
        });
      }
      function e3(e, t) {
      ...
      let e4 = (0, y.dt)({
        ...
        e9 = (0, y.IX)(
          (0, y.dt)({ slot: (0, y.Rx)(), prioritizationFee: (0, y.Rx)() })
        ),
        e7 = (0, y.dt)({
          total: (0, y.Rx)(),
          validator: (0, y.Rx)(),
        ...
        tu = e2(
          (0, y.dt)({
            ...
            innerInstructions: (0, y.jt)(
              (0, y.AG)(
                (0, y.IX)(
                  (0, y.dt)({
                    index: (0, y.Rx)(),
                    instructions: (0, y.IX)((0, y.G0)([ta, tc])),
                  })
                )
              )
            ),
        ...
        tl = e2(
          (0, y.dt)({
            ...
            range: (0, y.dt)({ firstSlot: (0, y.Rx)(), lastSlot: (0, y.Rx)() }),
          })
        ),
        td = e8(e4),
        th = e8(e7),
        ...
        tb = e2(
          (0, y.dt)({
            ...
            nonCirculatingAccounts: (0, y.IX)(e$),
          })
        ),
        tk = (0, y.dt)({
          amount: (0, y.Z_)(),
        ...
        tA = e2((0, y.IX)((0, y.dt)({ lamports: (0, y.Rx)(), address: e$ }))),
        tR = (0, y.dt)({
          executable: (0, y.O7)(),
          owner: e$,
          lamports: (0, y.Rx)(),
        ...
        tx = (0, y.dt)({ pubkey: e$, account: tR }),
        tP = (0, y.oQ)(
          (0, y.G0)([(0, y.eE)(s.Buffer), tI]),
          (0, y.G0)([eF, tI]),
          (e) => (Array.isArray(e) ? (0, y.Ue)(e, eZ) : e)
        ),
        tv = (0, y.dt)({
          executable: (0, y.O7)(),
          owner: e$,
        ...
        tL = (0, y.dt)({ subscription: (0, y.Rx)(), result: e5(tR) }),
        tO = (0, y.dt)({ pubkey: e$, account: tR }),
        tW = (0, y.dt)({ subscription: (0, y.Rx)(), result: e5(tO) }),
        tK = (0, y.dt)({
          parent: (0, y.Rx)(),
          slot: (0, y.Rx)(),
          root: (0, y.Rx)(),
        }),
        tN = (0, y.dt)({ subscription: (0, y.Rx)(), result: tK }),
        tz = (0, y.G0)([
          (0, y.dt)({
            type: (0, y.G0)([
              (0, y.i0)("firstShredReceived"),
              (0, y.i0)("completed"),
              (0, y.i0)("optimisticConfirmation"),
              (0, y.i0)("root"),
            ]),
            slot: (0, y.Rx)(),
            timestamp: (0, y.Rx)(),
        ...
        tU = (0, y.dt)({ subscription: (0, y.Rx)(), result: tz }),
        tq = (0, y.dt)({
          subscription: (0, y.Rx)(),
          result: e5((0, y.G0)([tn, ts])),
        }),
        tM = (0, y.dt)({ subscription: (0, y.Rx)(), result: (0, y.Rx)() }),
        tG = (0, y.dt)({
          pubkey: (0, y.Z_)(),
        ...
        tJ = e8(
          (0, y.dt)({ current: (0, y.IX)(tj), delinquent: (0, y.IX)(tj) })
        ),
        tV = (0, y.G0)([
          (0, y.i0)("processed"),
          (0, y.i0)("confirmed"),
        ...
        tD = (0, y.dt)({
          ...
          err: ti,
          confirmationStatus: (0, y.jt)(tV),
        }),
        tH = e2((0, y.IX)((0, y.AG)(tD))),
        t$ = e8((0, y.Rx)()),
        tF = (0, y.dt)({
          accountKey: e$,
        ...
        tZ = (0, y.dt)({
          ...
          message: (0, y.dt)({
            ...
            addressTableLookups: (0, y.jt)((0, y.IX)(tF)),
          }),
        }),
        tX = (0, y.dt)({
          pubkey: e$,
          ...
          writable: (0, y.O7)(),
          source: (0, y.jt)(
            (0, y.G0)([(0, y.i0)("transaction"), (0, y.i0)("lookupTable")])
          ),
        }),
        tY = (0, y.dt)({
          accountKeys: (0, y.IX)(tX),
          signatures: (0, y.IX)((0, y.Z_)()),
        }),
        tQ = (0, y.dt)({
          parsed: (0, y._4)(),
        ...
        t2 = (0, y.oQ)(t1, t8, (e) =>
          "accounts" in e ? (0, y.Ue)(e, t0) : (0, y.Ue)(e, tQ)
        ),
        t5 = (0, y.dt)({
          signatures: (0, y.IX)((0, y.Z_)()),
          message: (0, y.dt)({
            accountKeys: (0, y.IX)(tX),
            instructions: (0, y.IX)(t2),
            recentBlockhash: (0, y.Z_)(),
            addressTableLookups: (0, y.jt)((0, y.AG)((0, y.IX)(tF))),
          }),
        }),
        t3 = (0, y.dt)({
          accountIndex: (0, y.Rx)(),
        ...
        t4 = (0, y.dt)({ writable: (0, y.IX)(e$), readonly: (0, y.IX)(e$) }),
        t6 = (0, y.dt)({
          err: ti,
          fee: (0, y.Rx)(),
          innerInstructions: (0, y.jt)(
          ...
          preTokenBalances: (0, y.jt)((0, y.AG)((0, y.IX)(t3))),
          postTokenBalances: (0, y.jt)((0, y.AG)((0, y.IX)(t3))),
          loadedAddresses: (0, y.jt)(t4),
        ...
        t9 = (0, y.dt)({
          ...
          innerInstructions: (0, y.jt)(
            (0, y.AG)(
              (0, y.IX)(
                (0, y.dt)({ index: (0, y.Rx)(), instructions: (0, y.IX)(t2) })
              )
            )
          ),
          preBalances: (0, y.IX)((0, y.Rx)()),
        ...
        t7 = (0, y.G0)([(0, y.i0)(0), (0, y.i0)("legacy")]),
        re = (0, y.dt)({
          pubkey: (0, y.Z_)(),
          lamports: (0, y.Rx)(),
        ...
        ra = e8(
          (0, y.AG)(
            (0, y.dt)({
              ...
              parentSlot: (0, y.Rx)(),
              transactions: (0, y.IX)(
                (0, y.dt)({ transaction: tZ, meta: (0, y.AG)(t6) })
              ),
              rewards: (0, y.jt)((0, y.IX)(re)),
              blockTime: (0, y.AG)((0, y.Rx)()),
            })
        ...
        rd = e2(
          (0, y.dt)({
            blockhash: (0, y.Z_)(),
            feeCalculator: (0, y.dt)({ lamportsPerSignature: (0, y.Rx)() }),
          })
        ),
        rh = e2(
          (0, y.dt)({
        ...
        rS = (0, y.dt)({ result: e5(rk), subscription: (0, y.Rx)() }),
        rw = { "solana-client": "js/1.0.0-maintenance" };
      class rI {
        constructor(e, t) {
          var r, i;
          let n, s, o, a, c, u;
        ...
        async getBalanceAndContext(e, t) {
          let { commitment: r, config: i } = eY(t),
            ...
            o = (0, y.Ue)(s, e2((0, y.Rx)()));
          if ("error" in o)
            throw new eS(o.error, `failed to get balance for ${e.toBase58()}`);
          return o.result;
        }
        ...
        async getSupply(e) {
          ...
          let r = await this._rpcRequest("getSupply", [t]),
            i = (0, y.Ue)(r, tb);
          if ("error" in i) throw new eS(i.error, "failed to get supply");
          return i.result;
        }
        async getTokenSupply(e, t) {
          let r = this._buildArgs([e.toBase58()], t),
            ...
            n = (0, y.Ue)(i, e2(tk));
          if ("error" in n) throw new eS(n.error, "failed to get token supply");
          return n.result;
        }
        async getTokenAccountBalance(e, t) {
          let r = this._buildArgs([e.toBase58()], t),
            ...
            n = (0, y.Ue)(i, e2(tk));
          if ("error" in n)
            throw new eS(n.error, "failed to get token account balance");
          return n.result;
        }
        ...
        async getLargestAccounts(e) {
          let t = { ...e, commitment: (e && e.commitment) || this.commitment },
            ...
            n = (0, y.Ue)(i, tA);
          if ("error" in n)
            throw new eS(n.error, "failed to get largest accounts");
          return n.result;
        }
        async getTokenLargestAccounts(e, t) {
          let r = this._buildArgs([e.toBase58()], t),
            ...
            n = (0, y.Ue)(i, tS);
          if ("error" in n)
            throw new eS(n.error, "failed to get token largest accounts");
          return n.result;
        }
        ...
        async getMultipleParsedAccounts(e, t) {
          let { commitment: r, config: i } = eY(t),
            ...
            a = (0, y.Ue)(o, e2((0, y.IX)((0, y.AG)(tv))));
          if ("error" in a)
            throw new eS(a.error, `failed to get info for accounts ${n}`);
          return a.result;
        }
        async getMultipleAccountsInfoAndContext(e, t) {
          let { commitment: r, config: i } = eY(t),
            ...
            o = await this._rpcRequest("getMultipleAccounts", s),
            a = (0, y.Ue)(o, e2((0, y.IX)((0, y.AG)(tR))));
          if ("error" in a)
            throw new eS(a.error, `failed to get info for accounts ${n}`);
          return a.result;
        }
        ...
        async getProgramAccounts(e, t) {
          let { commitment: r, config: i } = eY(t),
            ...
            o = this._buildArgs([e.toBase58()], r, n || "base64", {
              ...s,
              ...(s.filters ? { filters: eQ(s.filters) } : null),
            }),
            a = await this._rpcRequest("getProgramAccounts", o),
            c = (0, y.IX)(tx),
            u =
              !0 === s.withContext ? (0, y.Ue)(a, e2(c)) : (0, y.Ue)(a, e8(c));
          if ("error" in u)
            throw new eS(
              u.error,
        ...
        async confirmTransaction(e, t) {
          ...
          return (F(64 === i.length, "signature has invalid length"),
          "string" == typeof e)
          ...
          let n,
            ...
            o = new Promise((t) => {
              ...
              (async () => {
                ...
                if (!s) {
                  for (; e <= r; )
                    if ((await eI(1e3), s || ((e = await i()), s))) return;
              ...
              (async () => {
                if (((s = await c()), !a))
                  for (;;) {
                    ...
                    if ((await eI(2e3), a || ((s = await c()), a))) return;
                  }
              })();
            }),
            ...
            if (t.__type === ei.PROCESSED) o = t.response;
              ...
              if (i?.value) {
                ...
                switch (t) {
                  ...
                  case "single":
                  case "singleGossip":
                    if ("confirmed" !== r && "finalized" !== r) throw new G(s);
                    break;
                  case "finalized":
                  case "max":
                  case "root":
                    if ("finalized" !== r) throw new G(s);
                }
                o = { context: i.context, value: { err: i.value.err } };
              } else throw new G(s);
            }
          } finally {
            (a = !0), u();
        ...
        async confirmTransactionUsingLegacyTimeoutStrategy({
          ...
          let n = new Promise((t) => {
              ...
              r = setTimeout(
                () => t({ __type: ei.TIMED_OUT, timeoutMs: i }),
                i
              );
            }),
        ...
        async getVoteAccounts(e) {
          let t = this._buildArgs([], e),
            ...
            i = (0, y.Ue)(r, tJ);
          if ("error" in i)
            throw new eS(i.error, "failed to get vote accounts");
          return i.result;
        }
        async getSlot(e) {
        ...
        async getSlotLeaders(e, t) {
          let r = await this._rpcRequest("getSlotLeaders", [e, t]),
            i = (0, y.Ue)(r, e8((0, y.IX)(e$)));
          if ("error" in i) throw new eS(i.error, "failed to get slot leaders");
          return i.result;
        }
        async getSignatureStatus(e, t) {
          ...
          return F(1 === i.length), { context: r, value: i[0] };
        }
        async getSignatureStatuses(e, t) {
          ...
          let i = await this._rpcRequest("getSignatureStatuses", r),
            n = (0, y.Ue)(i, tH);
          if ("error" in n)
            throw new eS(n.error, "failed to get signature status");
          return n.result;
        }
        ...
        async getInflationGovernor(e) {
          let t = this._buildArgs([], e),
            ...
            i = (0, y.Ue)(r, td);
          if ("error" in i) throw new eS(i.error, "failed to get inflation");
          return i.result;
        }
        async getInflationReward(e, t, r) {
          let { commitment: i, config: n } = eY(r),
            ...
            a = (0, y.Ue)(o, e6);
          if ("error" in a)
            throw new eS(a.error, "failed to get inflation reward");
          return a.result;
        }
        ...
        async getRecentBlockhashAndContext(e) {
          let t = this._buildArgs([], e),
            ...
            i = (0, y.Ue)(r, rd);
          if ("error" in i)
            throw new eS(i.error, "failed to get recent blockhash");
          return i.result;
        }
        ...
        async getFeeCalculatorForBlockhash(e, t) {
          let r = this._buildArgs([e], t),
            ...
            n = (0, y.Ue)(i, rm);
          if ("error" in n)
            throw new eS(n.error, "failed to get fee calculator");
          let { context: s, value: o } = n.result;
          return { context: s, value: null !== o ? o.feeCalculator : null };
        }
        async getFeeForMessage(e, t) {
          let r = P(e.serialize()).toString("base64"),
        ...
        async getRecentPrioritizationFees(e) {
          let t = e?.lockedWritableAccounts?.map((e) => e.toBase58()),
            ...
            n = (0, y.Ue)(i, tg);
          if ("error" in n)
            throw new eS(n.error, "failed to get recent prioritization fees");
          return n.result;
        }
        ...
        async getTransaction(e, t) {
          let { commitment: r, config: i } = eY(t),
            ...
            o = (0, y.Ue)(s, ru);
          if ("error" in o) throw new eS(o.error, "failed to get transaction");
          let a = o.result;
          return a
            ? {
                ...a,
        ...
        async getConfirmedBlock(e, t) {
          let r = this._buildArgsAtLeastConfirmed([e], t),
            ...
            n = (0, y.Ue)(i, ra);
          if ("error" in n)
            throw new eS(n.error, "failed to get confirmed block");
          let s = n.result;
        ...
        async getBlockSignatures(e, t) {
          let r = this._buildArgsAtLeastConfirmed([e], t, void 0, {
            ...
            n = (0, y.Ue)(i, rc);
          if ("error" in n) throw new eS(n.error, "failed to get block");
          let s = n.result;
        ...
        async getConfirmedTransaction(e, t) {
          let r = this._buildArgsAtLeastConfirmed([e], t),
            ...
            n = (0, y.Ue)(i, ru);
          if ("error" in n) throw new eS(n.error, "failed to get transaction");
          let s = n.result;
          if (!s) return s;
          let o = new ee(s.transaction.message),
            a = s.transaction.signatures;
          return { ...s, transaction: eo.populate(o, a) };
        }
        async getParsedConfirmedTransaction(e, t) {
          let r = this._buildArgsAtLeastConfirmed([e], t, "jsonParsed"),
            ...
            n = (0, y.Ue)(i, rl);
          if ("error" in n)
            throw new eS(n.error, "failed to get confirmed transaction");
          return n.result;
        }
        ...
        async getAddressLookupTable(e, t) {
          ...
          return (
            null !== i &&
              (n = new eV({ key: e, state: eV.deserialize(i.data) })),
            { context: r, value: n }
          );
        }
        async getNonceAndContext(e, t) {
          let { context: r, value: i } = await this.getAccountInfoAndContext(
            ...
            n = null;
          return (
            null !== i && (n = ev.fromAccountData(i.data)),
            { context: r, value: n }
          );
        }
        async getNonce(e, t) {
        ...
        async requestAirdrop(e, t) {
          let r = await this._rpcRequest("requestAirdrop", [e.toBase58(), t]),
            i = (0, y.Ue)(r, rf);
          if ("error" in i)
            throw new eS(i.error, `airdrop to ${e.toBase58()} failed`);
          return i.result;
        }
        async _blockhashWithExpiryBlockHeight(e) {
          if (!e) {
            for (; this._pollingBlockhash; ) await eI(100);
        ...
        async simulateTransaction(e, t, r) {
          ...
          if (r) {
            let e = (Array.isArray(r) ? r : n.nonProgramIds()).map((e) =>
              e.toBase58()
            );
              ...
              if (void 0 !== r)
                switch (r.state) {
                  ...
                  case "subscribed":
                    0 === r.callbacks.size &&
                      (await (async () => {
                        let { serverSubscriptionId: i, unsubscribeMethod: n } =
                          r;
                        if (this._subscriptionsAutoDisposedByRpc.has(i))
                          ...
                          try {
                            ...
                            if (
                              (i instanceof Error &&
                                console.error(`${n} error:`, i.message),
                              !t())
                            )
                              return;
                            this._setSubscription(e, {
        ...
        _wsOnAccountNotification(e) {
          let { result: t, subscription: r } = (0, y.Ue)(e, tL);
        ...
        _wsOnProgramAccountNotification(e) {
          let { result: t, subscription: r } = (0, y.Ue)(e, tW);
        ...
        _wsOnLogsNotification(e) {
          let { result: t, subscription: r } = (0, y.Ue)(e, rS);
          this._handleServerNotification(r, [t.value, t.context]);
        }
        _wsOnSlotNotification(e) {
          let { result: t, subscription: r } = (0, y.Ue)(e, tN);
        ...
        _wsOnSlotUpdatesNotification(e) {
          let { result: t, subscription: r } = (0, y.Ue)(e, tU);
          this._handleServerNotification(r, [t]);
        }
        onSlotUpdate(e) {
          return this._makeSubscription(
        ...
        _wsOnSignatureNotification(e) {
          let { result: t, subscription: r } = (0, y.Ue)(e, tq);
        ...
        _wsOnRootNotification(e) {
          let { result: t, subscription: r } = (0, y.Ue)(e, tM);
          this._handleServerNotification(r, [t]);
        }
        onRootChange(e) {
          return this._makeSubscription(
      ...
      class r_ {
        ...
        static fromSecretKey(e, t) {
          ...
          return new r_({ publicKey: r, secretKey: e });
        }
        static fromSeed(e) {
          let t = _(e),
            r = new Uint8Array(64);
          return r.set(e), r.set(t, 32), new r_({ publicKey: t, secretKey: r });
        }
        get publicKey() {
      ...
      class rR {
        ...
        static decodeCreateLookupTable(e) {
          ...
          let { recentSlot: t } = eA(rA.CreateLookupTable, e.data);
          return {
        ...
        static decodeExtendLookupTable(e) {
          ...
          let { addresses: t } = eA(rA.ExtendLookupTable, e.data);
          return {
        ...
        static createLookupTable(e) {
          let [t, r] = O.findProgramAddressSync(
            ...
            n = [
              ...
              { pubkey: eL.programId, isSigner: !1, isWritable: !1 },
            ];
          return [new es({ programId: this.programId, keys: n, data: i }), t];
        }
        static freezeLookupTable(e) {
          let t = e_(rA.FreezeLookupTable),
            r = [
              { pubkey: e.lookupTable, isSigner: !1, isWritable: !0 },
              { pubkey: e.authority, isSigner: !0, isWritable: !1 },
            ];
          return new es({ programId: this.programId, keys: r, data: t });
        }
        static extendLookupTable(e) {
          let t = e_(rA.ExtendLookupTable, {
          ...
          return (
            ...
            new es({ programId: this.programId, keys: r, data: t })
          );
        }
        static deactivateLookupTable(e) {
          let t = e_(rA.DeactivateLookupTable),
            r = [
              { pubkey: e.lookupTable, isSigner: !1, isWritable: !0 },
              { pubkey: e.authority, isSigner: !0, isWritable: !1 },
            ];
      ...
      rx.programId = new O("AddressLookupTab1e1111111111111111111111111");
      class rP {
        constructor() {}
        static decodeInstructionType(e) {
          let t;
        ...
        static decodeRequestUnits(e) {
          this.checkProgramId(e.programId);
          let { units: t, additionalFee: r } = eA(rv.RequestUnits, e.data);
          return { units: t, additionalFee: r };
        }
        static decodeRequestHeapFrame(e) {
          this.checkProgramId(e.programId);
          let { bytes: t } = eA(rv.RequestHeapFrame, e.data);
          return { bytes: t };
        }
        static decodeSetComputeUnitLimit(e) {
          this.checkProgramId(e.programId);
          let { units: t } = eA(rv.SetComputeUnitLimit, e.data);
          return { units: t };
        }
        static decodeSetComputeUnitPrice(e) {
          this.checkProgramId(e.programId);
          let { microLamports: t } = eA(rv.SetComputeUnitPrice, e.data);
      ...
      let rv = Object.freeze({
        ...
        SetComputeUnitPrice: {
          index: 3,
          layout: g.n_([g.u8("instruction"), eB("microLamports")]),
        },
      });
      class rE {
        constructor() {}
        static requestUnits(e) {
          ...
          return new es({ keys: [], programId: this.programId, data: t });
        }
      ...
      rE.programId = new O("ComputeBudget111111111111111111111111111111");
      let rB = g.n_([
        g.u8("numSignatures"),
        g.u8("padding"),
      ...
      class rT {
        ...
        static createInstructionWithPublicKey(e) {
          ...
          return (
            ...
            u.fill(i, a),
            u.fill(r, c),
            new es({ keys: [], programId: rT.programId, data: u })
          );
        }
      ...
      rT.programId = new O("Ed25519SigVerify111111111111111111111111111");
      let rC = (e, t) => {
        let r = S.kA.sign(e, t);
        return [r.toCompactRawBytes(), r.recovery];
      };
      S.kA.utils.isValidPrivateKey;
      let rL = S.kA.getPublicKey,
        rO = g.n_([
          g.u8("numSignatures"),
          g.KB("signatureOffset"),
      ...
      class rW {
        ...
        static publicKeyToEthAddress(e) {
          ...
          try {
            return s.Buffer.from((0, k.fr)(P(e))).slice(-20);
          } catch (e) {
            throw Error(`Error constructing BSC address: ${e}`);
          }
        }
        static createInstructionWithPublicKey(e) {
          let {
        ...
        static createInstructionWithEthAddress(e) {
          ...
          let c = 12 + t.length,
            u = c + n.length + 1,
            l = s.Buffer.alloc(rO.span + i.length);
          return (
            rO.encode(
              {
                numSignatures: 1,
            ...
            l.fill(P(i), rO.span),
            new es({ keys: [], programId: rW.programId, data: l })
          );
        }
        static createInstructionWithPrivateKey(e) {
          let { privateKey: t, message: r, instructionIndex: i } = e;
      ...
      rW.programId = new O("KeccakSecp256k11111111111111111111111111111");
      ...
      rz.default = new rz(0, 0, O.default);
      class rU {
        constructor() {}
        static decodeInstructionType(e) {
          let t;
        ...
        static decodeInitialize(e) {
          this.checkProgramId(e.programId), this.checkKeyLength(e.keys, 2);
          let { authorized: t, lockup: r } = eA(rq.Initialize, e.data);
          return {
            stakePubkey: e.keys[0].pubkey,
            authorized: new rN(new O(t.staker), new O(t.withdrawer)),
            lockup: new rz(r.unixTimestamp, r.epoch, new O(r.custodian)),
          };
        }
        ...
        static decodeAuthorize(e) {
          this.checkProgramId(e.programId), this.checkKeyLength(e.keys, 3);
          let { newAuthorized: t, stakeAuthorizationType: r } = eA(
              rq.Authorize,
              e.data
            ),
            i = {
        ...
        static decodeAuthorizeWithSeed(e) {
          ...
          let {
              ...
              authoritySeed: i,
              authorityOwner: n,
            } = eA(rq.AuthorizeWithSeed, e.data),
            s = {
              stakePubkey: e.keys[0].pubkey,
              authorityBase: e.keys[1].pubkey,
              authoritySeed: i,
              authorityOwner: new O(n),
              newAuthorizedPubkey: new O(t),
              stakeAuthorizationType: { index: r },
            };
        ...
        static decodeSplit(e) {
          this.checkProgramId(e.programId), this.checkKeyLength(e.keys, 3);
          let { lamports: t } = eA(rq.Split, e.data);
          return {
            stakePubkey: e.keys[0].pubkey,
        ...
        static decodeWithdraw(e) {
          this.checkProgramId(e.programId), this.checkKeyLength(e.keys, 5);
          let { lamports: t } = eA(rq.Withdraw, e.data),
            r = {
              stakePubkey: e.keys[0].pubkey,
              toPubkey: e.keys[1].pubkey,
              authorizedPubkey: e.keys[4].pubkey,
      ...
      let rq = Object.freeze({
          Initialize: {
            ...
            layout: g.n_([
              g.Jq("instruction"),
              ((e = "authorized") => g.n_([J("staker"), J("withdrawer")], e))(),
              ((e = "lockup") =>
                g.n_(
                  [g.gM("unixTimestamp"), g.gM("epoch"), J("custodian")],
                  e
                ))(),
            ]),
          },
        ...
        rM = Object.freeze({ Staker: { index: 0 }, Withdrawer: { index: 1 } });
      class rG {
        constructor() {}
        static initialize(e) {
          let { stakePubkey: t, authorized: r, lockup: i } = e,
            ...
            s = e_(rq.Initialize, {
              authorized: {
                staker: P(r.staker.toBuffer()),
                withdrawer: P(r.withdrawer.toBuffer()),
              },
              lockup: {
                unixTimestamp: n.unixTimestamp,
                epoch: n.epoch,
                custodian: P(n.custodian.toBuffer()),
              },
            });
          return new es({
            keys: [
        ...
        static createAccountWithSeed(e) {
          ...
          return t.add(
            this.initialize({ stakePubkey: r, authorized: i, lockup: n })
          );
        }
        static createAccount(e) {
          let t = new eo();
        ...
        static delegate(e) {
          ...
          return new eo().add({
            keys: [
              ...
              { pubkey: eu, isSigner: !1, isWritable: !1 },
              { pubkey: ef, isSigner: !1, isWritable: !1 },
              { pubkey: rK, isSigner: !1, isWritable: !1 },
        ...
        static authorize(e) {
          let {
            ...
            o = e_(rq.Authorize, {
              newAuthorized: P(i.toBuffer()),
              stakeAuthorizationType: n.index,
            }),
            a = [
              { pubkey: t, isSigner: !1, isWritable: !0 },
              { pubkey: eu, isSigner: !1, isWritable: !0 },
              { pubkey: r, isSigner: !0, isWritable: !1 },
            ];
          return (
            s && a.push({ pubkey: s, isSigner: !0, isWritable: !1 }),
            new eo().add({ keys: a, programId: this.programId, data: o })
          );
        }
        static authorizeWithSeed(e) {
          let {
            ...
            c = e_(rq.AuthorizeWithSeed, {
              newAuthorized: P(s.toBuffer()),
              stakeAuthorizationType: o.index,
              authoritySeed: i,
              authorityOwner: P(n.toBuffer()),
            }),
            u = [
              { pubkey: t, isSigner: !1, isWritable: !0 },
              { pubkey: r, isSigner: !0, isWritable: !1 },
      ...
      (rG.programId = new O("Stake11111111111111111111111111111111111111")),
        (rG.space = 200);
      class rj {
        constructor(e, t, r, i) {
      ...
      class rJ {
        ...
        static decodeInitializeAccount(e) {
          ...
          let { voteInit: t } = eA(rV.InitializeAccount, e.data);
          return {
        ...
        static decodeAuthorize(e) {
          this.checkProgramId(e.programId), this.checkKeyLength(e.keys, 3);
          let { newAuthorized: t, voteAuthorizationType: r } = eA(
            rV.Authorize,
            e.data
          );
          return {
        ...
        static decodeWithdraw(e) {
          this.checkProgramId(e.programId), this.checkKeyLength(e.keys, 3);
          let { lamports: t } = eA(rV.Withdraw, e.data);
          return {
            votePubkey: e.keys[0].pubkey,
            ...
            layout: g.n_([
              ...
              ((e = "voteAuthorizeWithSeedArgs") =>
                g.n_(
                  [
                    g.Jq("voteAuthorizationType"),
                    J("currentAuthorityDerivedKeyOwnerPubkey"),
      ...
      class rH {
        ...
        static initializeAccount(e) {
          let { votePubkey: t, nodePubkey: r, voteInit: i } = e,
            n = e_(rV.InitializeAccount, {
              voteInit: {
                nodePubkey: P(i.nodePubkey.toBuffer()),
                authorizedVoter: P(i.authorizedVoter.toBuffer()),
                authorizedWithdrawer: P(i.authorizedWithdrawer.toBuffer()),
        ...
        static authorizeWithSeed(e) {
          let {
            ...
            a = e_(rV.AuthorizeWithSeed, {
              voteAuthorizeWithSeedArgs: {
                currentAuthorityDerivedKeyOwnerPubkey: P(r.toBuffer()),
                currentAuthorityDerivedKeySeed: i,
                newAuthorized: P(n.toBuffer()),
        ...
        static updateValidatorIdentity(e) {
          let {
            ...
            n = e_(rV.UpdateValidatorIdentity);
          return new eo().add({
            keys: [
              { pubkey: t, isSigner: !1, isWritable: !0 },
              { pubkey: i, isSigner: !0, isWritable: !1 },
      ...
      (rH.programId = new O("Vote111111111111111111111111111111111111111")),
        (rH.space = 3762);
      let r$ = new O("Va1idator1nfo111111111111111111111111111111"),
        rF = (0, y.dt)({
          name: (0, y.Z_)(),
          website: (0, y.jt)((0, y.Z_)()),
          details: (0, y.jt)((0, y.Z_)()),
          iconUrl: (0, y.jt)((0, y.Z_)()),
      ...
      class rZ {
        ...
        static fromConfigData(e) {
          let t = [...e];
          if (2 !== H(t)) return null;
          let r = [];
          for (let e = 0; e < 2; e++) {
            let e = new O(Q(t, 0, C)),
              i = 1 === Y(t);
            r.push({ publicKey: e, isSigner: i });
          }
          if (r[0].publicKey.equals(r$) && r[1].isSigner) {
            let e = JSON.parse(D().decode(s.Buffer.from(t)));
            return (0, y.hu)(e, rF), new rZ(r[1].publicKey, e);
          }
          return null;
        }
      }
      let rX = new O("Vote111111111111111111111111111111111111111"),
        rY = g.n_([
          J("nodePubkey"),
          J("authorizedWithdrawer"),
          g.u8("commission"),
          ...
          g._O(),
          g.A9(
            g.n_([g._O("epoch"), J("authorizedVoter")]),
            g.cv(g.Jq(), -8),
            "authorizedVoters"
          ),
          g.n_(
          ...
          return (
            ...
            new rQ({
              ...
              priorVoters: (function ({ buf: e, idx: t, isEmpty: r }) {
                return r
                  ? []
                  : [...e.slice(t + 1).map(r1), ...e.slice(0, t).map(r1)];
              })(t.priorVoters),
