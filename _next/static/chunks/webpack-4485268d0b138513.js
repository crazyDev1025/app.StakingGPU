  ...
  (d.m = a),
    ...
    (d.u = function (e) {
      return (
        ...
        "." +
        {
          673: "6f7fb272a9abce40",
          944: "c55cbd754f092ab8",
          956: "6e317bdcddc013fd",
        }[e] +
        ".js"
      );
    }),
    ...
    (d.p = "/_next/"),
    (i = { 272: 0, 289: 0, 465: 0, 636: 0 }),
    (d.f.j = function (e, t) {
      var n = d.o(i, e) ? i[e] : void 0;
      if (0 !== n) {
        if (n) t.push(n[2]);
        else if (/^(272|289|465|636)$/.test(e)) i[e] = 0;
        else {
...
(function () {
  ...
  s.setAttribute("data-deployment-id", "dpl_Fh2BRRHvwcMPYSnabTvrMfzNWSG4");
